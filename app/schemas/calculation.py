...
class CalculationResponse(CalculationBase):
    ...
    previous_inputs: Optional[List[float]] = Field(
        None,
        description="Previous input values stored for undo functionality"
    )
    redo_inputs: Optional[List[float]] = Field(
        None,
        description="Redo input values stored for redo functionality"
    )
